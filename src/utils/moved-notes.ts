 ...
 */
export const NOTES_HOME = 'https://www.mart1n.xyz';

export const MOVED_NOTES: Record<string, string> = {
  'zerolend-liquidity-index-manipulation':
    'https://www.mart1n.xyz/security/zerolend-liquidity-index-manipulation',
  'hinkal-usdc-shielded-pool-drain':
    'https://www.mart1n.xyz/security/hinkal-usdc-shielded-pool-drain',
  'summerfi-fleetcommander-nav-donation-drain':
    'https://www.mart1n.xyz/security/summerfi-fleetcommander-nav-donation-drain',
  'allbridge-core-solana-same-pool-account-aliasing-drain':
    'https://www.mart1n.xyz/security/allbridge-core-solana-same-pool-account-aliasing-drain',
  'processor-role-design-in-credit-vaults':
    'https://www.mart1n.xyz/research/processor-role-design-in-credit-vaults',
